...
Console.WriteLine("4 - Ricerca utente");
...
//3. inserire il suo cf per la modifica
{
...
//4. inserire il suo cf per la ricerca
...
else if (sceltaUtente == 4)
{
    ...
    if (cliente != null)
    {
        ...
        Console.WriteLine("Utente non trovato nel database");
